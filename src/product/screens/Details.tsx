        ...
        <Stack direction="row">
          ...
          >
            ...
            <Stack direction="column" padding="6" spacing={10}>
              ...
              <Text color="blackAlpha.700" fontSize="xl">
                Excelente calidad y diseño Premium Ojos bordados y relleno de vellón súper soft Muy
                suave y más hermoso que nunca!
              </Text>
              <Text color="blackAlpha.700" fontSize="xl">
                Descripción: -16cm a 25cm según el modelo - incluye sopapa para colgarlo -muy suave
                al tacto
              </Text>
              <Divider alignSelf="center" borderColor="blackAlpha.400" width="100%" />
              ...
              <Stack direction="row" spacing={6}>
                <Stack spacing={0}>
                  ...
                  <Stack alignItems="center" direction="row" heigth="4px" spacing={4} width="100%">
                    <Text
                      as="span"
